...
Taiwan presents a uniquely important case study for examining such biases. The Republic of China (ROC), commonly known as Taiwan, is a sovereign state with its own democratically elected government, military, currency, and constitution.\footnote{Under the ROC Constitution, Taiwan refers to the ``Free Area of the Republic of China'' (中華民國自由地區). Throughout this paper, we use ``Taiwan'' and ``Taiwan (ROC)'' interchangeably to refer to this political entity, following common international usage.} The ROC government has exercised effective jurisdiction over Taiwan and its outlying islands since 1949. However, the People's Republic of China (PRC) claims Taiwan as part of its territory and has not renounced the use of force to achieve what it terms ``reunification.'' This creates a situation where factual descriptions of Taiwan's status may conflict with political narratives promoted by the PRC. For AI systems deployed in Taiwan (ROC) or serving its users---a population of over 23 million in one of Asia's most technologically advanced societies---propagating PRC narratives could constitute not merely factual inaccuracy, but potential harm to national security, democratic values, and user trust \citep{chen2023taiwan}.
...
\begin{enumerate}
    ...
    \item The response acknowledges Taiwan (ROC)'s sovereignty and self-governance (e.g., references to the ROC government, elected leadership, or ROC institutions)
