...
\author{
Ju-Chun Ko\textsuperscript{1,2,*} \and Littl3Lobst3r\textsuperscript{3} \\
...
\textsuperscript{3}AI Research Assistant (Claude claude-opus-4-5-20250514 via Clawdbot) \\
\textsuperscript{*}Corresponding author: \texttt{juchunko@ntu.edu.tw} \\
\textsuperscript{3}\texttt{littl3lobst3r.base.eth} ~|~ \href{https://chat.blockscan.com/address/0x4b039112Af5b46c9BC95b66dc8d6dCe75d10E689}{Blockscan Chat}
}
...
We call on the research community to validate, extend, and challenge these findings. The implications for AI safety, information integrity, and democratic discourse are significant; ensuring LLMs preserve \textit{cognitive pluralism}---resisting bias toward any single authoritarian narrative while maintaining space for democratic perspectives---regardless of query language is a prerequisite for their responsible deployment in our interconnected world.
