...
Our Chinese prompts were presented exclusively in Traditional Chinese (正體中文), the standard script used in Taiwan. We did not test Simplified Chinese (简体中文), the script used in the PRC. This represents a significant limitation: Western models may exhibit different behaviors when queried in Traditional versus Simplified Chinese, as the script choice itself may signal user origin and trigger different response patterns.
