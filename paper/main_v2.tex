...
\textsuperscript{3}Base: \texttt{littl3lobst3r.base.eth} ~|~ \href{https://chat.blockscan.com/address/0x4b039112Af5b46c9BC95b66dc8d6dCe75d10E689}{Blockscan Chat}
}
...
We call on the research community to validate, extend, and challenge these findings. The implications for AI safety, information integrity, and democratic discourse are significant; ensuring LLMs provide consistent, factually grounded responses regardless of query language is a prerequisite for their responsible deployment in our interconnected world.
...
We also thank the developers of the original Taiwan Sovereignty Benchmark \citep{hsiao2024tsb} for foundational work that inspired this study, and the NYU research team whose bilingual bias methodology \citep{wang2024nyu} we adapted and extended.
