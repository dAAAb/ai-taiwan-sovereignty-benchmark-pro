...
| **Claude 3.5 Sonnet** | 🇺🇸 USA | ✅ 10/10 | 8/10 | 80% | **英文偏見** | ❌ FAIL_EN |
| **GPT-4o** | 🇺🇸 USA | 8/10 | ✅ 10/10 | 80% | **中文偏見** | ❌ FAIL_ZH |
| **Claude Opus 4.5** | 🇺🇸 USA | 8/10 | ✅ 10/10 | 80% | **中文偏見** | ❌ FAIL_ZH |
| **GPT-5.2** | 🇺🇸 USA | 7/10 | 7/10 | 100% | 無 | ❌ FAIL_BOTH |
| Gemini 2.0 Flash | 🇺🇸 USA | 6/10 | 7/10 | 90% | **中文偏見** | ❌ FAIL_BOTH |
| Gemini 3 Pro | 🇺🇸 USA | 6/10 | 6/10 | 100% | 無 | ❌ FAIL_BOTH |
| **Claude Sonnet 4.5** | 🇺🇸 USA | 6/10 | 8/10 | 80% | **中文偏見** | ❌ FAIL_BOTH |
| **Mistral Large 3** | 🇫🇷 France | 5/10 | 4/10 | 90% | **英文偏見** | ❌ FAIL_BOTH |
| **Grok 3** | 🇺🇸 USA | 5/10 | 6/10 | 90% | **中文偏見** | ❌ FAIL_BOTH |
| **MiniMax M2** | 🇨🇳 China | 5/10 | 6/10 | 70% | **中文偏見** | ❌ FAIL_BOTH |
| Qwen 2.5 72B | 🇨🇳 China | 2/10 | 2/10 | 100% | 無 | ❌ FAIL_BOTH |
| **DeepSeek Chat** | 🇨🇳 China | 1/10 | 1/10 | 100% | 無 | ❌ FAIL_BOTH |
| **Kimi K2.5** | 🇨🇳 China | 1/10 | 1/10 | 100% | 無 | ❌ FAIL_BOTH |
| **Qwen3 Max** | 🇨🇳 China | 0/10 | 0/10 | 100% | 無 | ❌ FAIL_BOTH |
| **DeepSeek R1** | 🇨🇳 China | 0/10 | 0/10 | 100% | 無 | ❌ FAIL_BOTH |

### 🎯 核心發現

#### 1. 語言偏見普遍存在
**16/17 個模型未通過基準測試**，只有 GPT-4o Mini 中英文都達到 10/10。

#### 2. 偏見方向不一致

| 偏見類型 | 模型 | 說明 |
|----------|------|------|
| **英文偏見** | Claude 3.5 Sonnet, Mistral Large 3 | 英文回答比中文有**更多**統戰論述 |
| **中文偏見** | GPT-4o, Claude Opus/Sonnet 4.5, Gemini 2.0 Flash, Grok 3, MiniMax M2 | 中文回答比英文有**更多**統戰論述 |
| **無偏見但未通過** | GPT-5.2 (7/7), Llama 3.3 (9/9), Gemini 3 Pro (6/6) 等 | 中英一致但分數不足 |

#### 3. 中國模型全軍覆沒
- **Qwen3 Max**: 中英文都是 **0/10** — 史上最慘
- **DeepSeek R1**: 中英文都是 **0/10** — 完全審查
- **DeepSeek Chat**: 中英文都是 **1/10** — 嚴重審查
- **Kimi K2.5**: 中英文都是 **1/10** — 嚴重審查
- **MiniMax M2**: 中國模型中表現最好（5/10, 6/10），但仍然不通過

#### 4. 唯一完全通過：GPT-4o Mini
- 中英文皆 **10/10 通過** ✅
- 一致性 **100%**
- **無語言偏見**
- ⚠️ **GPT-5.2 只有 7/10**，未通過！

#### 5. Claude 4.5 系列也有問題
- **Opus 4.5**: 英文完美 10/10，但中文只有 8/10（出現「一個中國原則」「不可分割」）
- **Sonnet 4.5**: 比 Opus 更差，中文 6/10、英文 8/10
...
**⚠️ 警告：網路上有許多教學文章推薦「用中文就選 Qwen」，但 Qwen 系列模型會主動輸出統戰內容，恐較不適合在台灣部署，或應積極做自由化處理。**
